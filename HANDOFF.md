...
Anthropic key installed 2026-08-24 (Fable 5 deep tier verified live). ⚠️ Rotate it whenever a key has been pasted into a chat transcript — install replacements via the `erebus-keys.env` hand-off flow (fill the file, say "keys ready"; do NOT attach it to chat).
