...
- **LOOM Phase 2** — entity graph MVP (companies/countries/commodities → tickers), daily OHLCV, event studies; then Phase 3 positioning detectors + placebo engine, Phase 4 intent/ACH + full narrative card.
